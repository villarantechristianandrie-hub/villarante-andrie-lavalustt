...
<head>
    ...
    <style>
        :root { --ink: #17221d; --muted: #68736d; --paper: #f5f0e8; --panel: #fffdf8; --line: #d9d4c9; --coral: #e85d43; --mint: #c8e6d1; --shadow: 0 18px 50px rgba(31, 39, 32, .1); }
...
<main class="wrap">
    <header class="topbar">
        <div><p class="kicker">Product Manager / Inventory</p><h1>Products.</h1></div>
